    ...
    Column (Modifier.fillMaxWidth()) {
        ...
        Row (Modifier.weight(1f)) {
            ...
            ComposableInfoCard(
                ...
                bacgroundColor = Color(0xFFEADDFF),
            ...
            ComposableInfoCard(
                ...
                bacgroundColor = Color(0xFFD0BCFF),
                modifier = Modifier.weight(1f)
            )
        ...
        Row (Modifier.weight(1f)) {
            ...
            ComposableInfoCard(
                ...
                bacgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            ...
            ComposableInfoCard(
                ...
                bacgroundColor = Color(0xFFF6EDFF),
                modifier = Modifier.weight(1f)
            )
...
private fun ComposableInfoCard(title: String,
        ...
        Column (modifier = modifier.fillMaxSize().
                           background(bacgroundColor).padding(16.dp),
